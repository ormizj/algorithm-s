 ...
 * @param {Number} num 
 * @returns the index of the {sortedArr}; inserting the element in the returned index will to keep the {sortedArr} sorted
 */
export const sortedInsertIndex = (sortedArr, num) => {
